...
1. 顺序关系<br />编译
  1. 词法分析<br />将源代码分成一个有意义的词
  1. 语法分析<br />词法编程抽象语法树AST
  1. 代码优化
2. 组合关系<br />CSS
  1. 选择器
  1. 属性
  1. 值
3. 维度关系<br />JavaScript
3. 分类关系<br />CSS选择器


<br />_**例子：HTML的标签**_<br />[https://html.spec.whatwg.org/](https://html.spec.whatwg.org/)<br />
...
- 打断<br />表示不感兴趣，是一种提示
- 争论<br />压力面试<br />克制自己的情绪<br />论点、论据、论证
- 难题<br />展现分析过程<br />不一定给个最优解，可以给个次优解<br />缩小规模
### 题目类型
...
- ECMA JavaScript标准
下载地址：[ecma-international.org](http://ecma-international.org/)   Standards -> ECMA262 -> 下载PDF
[https://tc39.es/ecma262/](https://tc39.es/ecma262/)  最新更新ECMA 标准
- 常用网站
